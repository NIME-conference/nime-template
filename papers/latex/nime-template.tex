...
\documentclass[sigconf]{nimepaper}
...
%
\author{\anonymize{Author One}}
\affiliation{%
    \institution{\anonymize{Affilitation}}
  \city{\anonymize{City}}
  \country{\anonymize{Country}}
}

\author{\anonymize{Author Two}}
\affiliation{%
    \institution{\anonymize{Another Affilitation}}
  \city{\anonymize{City}}
  \country{\anonymize{Country}}
}

\author{\anonymize{Author Three}}
\affiliation{%
    \institution{\anonymize{More Affilitations}}
  \city{\anonymize{City}}
  \country{\anonymize{Country}}
}
%\author{
